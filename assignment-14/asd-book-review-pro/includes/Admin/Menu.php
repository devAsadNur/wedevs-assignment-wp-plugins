...
class Menu {
    ...
    public function admin_menu_handler() {
        add_menu_page( __( 'Book Review', 'asd-book-review-pro' ), __( 'Book Review', 'asd-book-review-pro' ), 'manage_options', 'book-review', [ $this, 'plugin_page_handler' ], 'dashicons-book' );
    }
