...
<div id="book-review-wrapper" class="container wrapper">
    ...
    <div class="book-review-content clearfix">
        <div class="book-review-thumb float-left">
            <img src="<?php esc_url( the_post_thumbnail_url() ); ?>" alt="<?php esc_attr_e( $post->post_title, 'asd-book-review' ); ?>" />
        </div>
        <div class="book-review-details float-left">
            <ul class="book-review-details-list">
                <li>
                    <span><?php esc_html_e( 'Writter', 'asd-book-review' ); ?>: </span>
                    <?php echo esc_html( $single_post_writter ); ?>
                </li>
                <li>
                    <span><?php esc_html_e( 'ISBN', 'asd-book-review' ); ?>: </span>
                    <?php echo esc_html( $single_post_isbn ); ?></li>
                </li>
                <li>
                    <span><?php esc_html_e( 'Year', 'asd-book-review' ); ?>: </span>
                    <?php echo esc_html( $single_post_year ); ?></li>
                </li>
                <li>
                    <span><?php esc_html_e( 'Price', 'asd-book-review' ); ?>: </span>
                    $<?php echo esc_html( $single_post_price ); ?></li>
                </li>
                <li>
                    <span><?php esc_html_e( 'Description', 'asd-book-review' ); ?>: </span>
