...
class ContactList extends \WP_List_Table {
    ...
    public function __construct() {
        parent::__construct( [
            'singular' => __( 'Contact', 'asd-contact-plus' ),
            'plural'   => __( 'Contacts', 'asd-contact-plus' ),
            'ajax'     => false,
        ] );
    }
    ...
    public function no_items() {
        echo __( 'No contact response found', 'asd-contact-plus' );
    }
    ...
    public function get_columns() {
        $columns = [
            ...
            'first_name' => __( 'First Name', 'asd-contact-plus' ),
            'last_name'  => __( 'Last Name', 'asd-contact-plus' ),
            'email'      => __( 'Email', 'asd-contact-plus' ),
            'message'    => __( 'Message', 'asd-contact-plus' ),
            'ip'         => __( 'User IP', 'asd-contact-plus' ),
            'created_at' => __( 'Date', 'asd-contact-plus' )
        ];
    ...
    public function get_bulk_actions() {
        $actions = [
            'trash' => __( 'Move to trash', 'asd-contact-plus' ),
        ];
